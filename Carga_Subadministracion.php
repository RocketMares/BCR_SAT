...
<body>
    ...
    <div class="container mt-5 pt-5">
        <center>
            <h1>Mantenimiento de Subadministración</h1>
        </center>
    </div>
    <div class="container pt-4">
        ...
        <form method="POST">
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    <button type="button" class="btn btn-primary" onclick="Registrar_Sub_administracion()">Registrar</button>
                </div>
            </div>
        </form>
    </div>
    <div class="container pt-4">
        ...
        <form method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="nombre_area_1" name="nombre_area_1">
                </div>
            </div>
            ...
            <fieldset class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="Estatus_activo" id="Estatus_activo" value="N">
                ...
                <div class="form-group row">
                    <div class="col-sm-10">
                        <button type="button" class="btn btn-primary" onclick="Actualiza_Sub_administracion()">Actualizar</button>
                    </div>
                </div>
        </form>
    </div>
